        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-lg opacity-80 max-w-xl">
              A simple place to draft stories, invite contributors, and keep
              everything organized. Sign up to start writing.
            </p>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-4">
          ...
          <div className="card bg-base-100 shadow">
            <div className="card-body">
              ...
              <p className="opacity-70">
                Invite others to collaborate on your story.
              </p>
            </div>
          </div>
          ...
          <div className="card bg-base-100 shadow">
            <div className="card-body">
              ...
              <p className="opacity-70">
                Discuss changes without losing context.
              </p>
            </div>
          </div>
        </div>
